...
SQL is the query language that databases can be written in. Relational is for data that 
can access data between each other through the use of keys.

- [ ] Why do tables need a `primary key`?
The primary key serves as it's unique id.

- [ ] What is the name given to a table column that references the primary key on another table.
Foreign key.

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
Another table that joins them.
